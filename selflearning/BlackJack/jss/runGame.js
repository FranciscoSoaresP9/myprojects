...
function hit(){
    ...
    if(count===0){
        ...
        document.getElementById('cash').innerHTML=(wallet-playerBet);
        for (let i = 0; i < 2; i++) {
        ...
        if((deck[0].name.indexOf('ace')!=-1 && deck[1].name.indexOf('jack')!=-1)||(deck[1].name.indexOf('ace')!=-1 && deck[0].name.indexOf('jack')!=-1)){
        ...
        count++;
            ...
            alert('You dont have cash. \nReduce your bet or charge the count')
        }}else{
